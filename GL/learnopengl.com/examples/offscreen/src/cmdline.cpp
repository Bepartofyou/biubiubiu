/*
  ...
  gengetopt --input=/home/bepartofyou/work/av/ffmpeg/biubiubiu/GL/learnopengl.com/examples/offscreen/doc/cmdline.ggo --include-getopt --output-dir=/home/bepartofyou/work/av/ffmpeg/biubiubiu/GL/learnopengl.com/examples/offscreen/src 
...
const char *gengetopt_args_info_purpose = "purpose: Use openGL to rotate a overlay image without sawtooth which ffmpeg can\nproduce ";

const char *gengetopt_args_info_usage = "Usage: ./offscreen -b back.png -f front.png ";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "description: Bepartofyou is a handsome guy";

const char *gengetopt_args_info_help[] = {
  "      --help             Print help and exit",
  "  -V, --version          Print version and exit",
  "  -b, --backimg=STRING   the back image",
  "  -f, --frontimg=STRING  the front image",
  "  -w, --winwidth=INT     windows  width, equal video  width  (default=`640')",
  "  -h, --winheight=INT    windows height, equal video height  (default=`480')",
  "  -p, --framerate=INT    video frame rate  (default=`25')",
  "  -d, --duration=INT     video play duration  (default=`5')",
  "  -s, --start=INT        genenate image start number  (default=`0')",
  "  -c, --direction        rotate clock direction  (default=off)",
  "  -o, --outpath=STRING   the output image file path  (default=`./')",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->backimg_given = 0 ;
  args_info->frontimg_given = 0 ;
  args_info->winwidth_given = 0 ;
  args_info->winheight_given = 0 ;
  args_info->framerate_given = 0 ;
  args_info->duration_given = 0 ;
  args_info->start_given = 0 ;
  args_info->direction_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->backimg_arg = NULL;
  args_info->backimg_orig = NULL;
  args_info->frontimg_arg = NULL;
  args_info->frontimg_orig = NULL;
  args_info->winwidth_arg = 640;
  args_info->winwidth_orig = NULL;
  args_info->winheight_arg = 480;
  args_info->winheight_orig = NULL;
  args_info->framerate_arg = 25;
  args_info->framerate_orig = NULL;
  args_info->duration_arg = 5;
  args_info->duration_orig = NULL;
  args_info->start_arg = 0;
  args_info->start_orig = NULL;
  args_info->direction_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->backimg_help = gengetopt_args_info_help[2] ;
  args_info->frontimg_help = gengetopt_args_info_help[3] ;
  args_info->winwidth_help = gengetopt_args_info_help[4] ;
  args_info->winheight_help = gengetopt_args_info_help[5] ;
  args_info->framerate_help = gengetopt_args_info_help[6] ;
  args_info->duration_help = gengetopt_args_info_help[7] ;
  args_info->start_help = gengetopt_args_info_help[8] ;
  args_info->direction_help = gengetopt_args_info_help[9] ;
  args_info->outpath_help = gengetopt_args_info_help[10] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->backimg_arg));
  free_string_field (&(args_info->backimg_orig));
  free_string_field (&(args_info->frontimg_arg));
  free_string_field (&(args_info->frontimg_orig));
  free_string_field (&(args_info->winwidth_orig));
  free_string_field (&(args_info->winheight_orig));
  free_string_field (&(args_info->framerate_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->backimg_given)
    write_into_file(outfile, "backimg", args_info->backimg_orig, 0);
  if (args_info->frontimg_given)
    write_into_file(outfile, "frontimg", args_info->frontimg_orig, 0);
  if (args_info->winwidth_given)
    write_into_file(outfile, "winwidth", args_info->winwidth_orig, 0);
  if (args_info->winheight_given)
    write_into_file(outfile, "winheight", args_info->winheight_orig, 0);
  if (args_info->framerate_given)
    write_into_file(outfile, "framerate", args_info->framerate_orig, 0);
  ...
  if (args_info->direction_given)
    write_into_file(outfile, "direction", 0, 0 );
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->backimg_given)
    {
      fprintf (stderr, "%s: '--backimg' ('-b') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->frontimg_given)
    {
      fprintf (stderr, "%s: '--frontimg' ('-f') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "Vb:f:w:h:p:d:s:co:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'b':	/* the back image.  */
        
        
          if (update_arg( (void *)&(args_info->backimg_arg), 
               &(args_info->backimg_orig), &(args_info->backimg_given),
              &(local_args_info.backimg_given), optarg, 0, 0, ARG_STRING,
          ...
          break;
        case 'f':	/* the front image.  */
        
        
          if (update_arg( (void *)&(args_info->frontimg_arg), 
               &(args_info->frontimg_orig), &(args_info->frontimg_given),
              &(local_args_info.frontimg_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "frontimg", 'f',
              additional_error))
            goto failure;
          ...
          break;
        case 'w':	/* windows  width, equal video  width.  */
        
        
          if (update_arg( (void *)&(args_info->winwidth_arg), 
               &(args_info->winwidth_orig), &(args_info->winwidth_given),
              &(local_args_info.winwidth_given), optarg, 0, "640", ARG_INT,
              check_ambiguity, override, 0, 0,
              "winwidth", 'w',
              additional_error))
            goto failure;
          ...
          break;
        case 'h':	/* windows height, equal video height.  */
        
        
          if (update_arg( (void *)&(args_info->winheight_arg), 
               &(args_info->winheight_orig), &(args_info->winheight_given),
              &(local_args_info.winheight_given), optarg, 0, "480", ARG_INT,
              check_ambiguity, override, 0, 0,
              "winheight", 'h',
              additional_error))
            goto failure;
          ...
          break;
        case 'p':	/* video frame rate.  */
        
        
          if (update_arg( (void *)&(args_info->framerate_arg), 
               &(args_info->framerate_orig), &(args_info->framerate_given),
              &(local_args_info.framerate_given), optarg, 0, "25", ARG_INT,
              check_ambiguity, override, 0, 0,
              "framerate", 'p',
              additional_error))
            goto failure;
        ...
        case 'd':	/* video play duration.  */
          ...
          break;
        case 's':	/* genenate image start number.  */
          ...
          break;
        case 'c':	/* rotate clock direction.  */
        
        
          if (update_arg((void *)&(args_info->direction_flag), 0, &(args_info->direction_given),
              &(local_args_info.direction_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "direction", 'c',
              additional_error))
            goto failure;
        
          break;
        case 'o':	/* the output image file path.  */
